...
YouTubePlayer = class extends EventEmitter {
    ...
    seek(e) {
        this._ready
            ? this._player.seekTo(e, !0)
            : this._queueCommand("seek", e);
    }
        ...
        if (t) {
            ...
            if (a) {
                ...
                (e.width = l),
                    ...
                    (o.style.marginTop =
                        Math.ceil(
                            -(parseFloat(o.style.height, 10) - e.height) / 2
                        ) + "px"),
                ...
                h &&
                    ...
                    (o.style.marginLeft =
                        Math.ceil(
                            -(parseFloat(o.style.width, 10) - e.width) / 2
                        ) + "px"));
                for (const t in i)
    ...
    setLoop(e) {
        this._ready
            ? this._player.setLoop(e)
            : this._queueCommand("setLoop", e);
    }
    getVolume() {
            ...
            this._player = new this._api.Player(this._id, {
                ...
                events: {
                    ...
                    onPlaybackQualityChange: (e) =>
                        this._onPlaybackQualityChange(e),
    ...
    _onStateChange(e) {
        if (!this.destroyed) {
            ...
            ["paused", "buffering", "ended"].includes(t) &&
                this._onTimeupdate(),
                this.emit(t),
                ["unstarted", "playing", "cued"].includes(t) &&
                    this._onTimeupdate();
        }
    }
        ...
        if (!this.destroyed) {
            ...
            if (t !== YOUTUBE_ERROR.HTML5_ERROR)
                return t === YOUTUBE_ERROR.UNPLAYABLE_1 ||
                    ...
                    : void this._destroy(
                          new Error(
                              "YouTube Player Error. Unknown error code: " + t
                          )
                      );
        }
    }
